                ...
                <div class="userBox loginUserBox">
                  ...
                  <div class="userBoxBottom loginUserBoxBottom">
                    ...
                    <div class="iconBox">
                      ...
                      <a href="http://8.140.175.119:8080/#/login">用客户端抢VIP</a>
...
export default {
  ...
  computed: {
    searchMovieValues() {
      ...
      if (searchMovieValues == "") {
        //查询购买页面的分页查询
        this.$axios.post('http://8.140.175.119:8087/queryBuyMoviePage', this.$qs.stringify({
          curr: 0
        })).then((res) => {
  ...
  methods: {
    ...
    //模糊查询出售电影名称
    searchMovie() {
      this.$axios.post('http://8.140.175.119:8087/searchBuyMovie', this.$qs.stringify({
